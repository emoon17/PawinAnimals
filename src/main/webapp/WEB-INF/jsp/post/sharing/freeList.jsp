...
<div class="container list-box">
	...
	<div class="search-box d-flex align-items-center">
		<!-- 글 서치 -->
		<div class="write-area font-weight-bold ml-3">따뜻한 나눔의 공간이에요!</div>
		<select id="status" name="status"
			class="content-foot-box ml-4 mr-3 text-center copy-font" style="height: 50px; width: 100px;">
		...
		<select id="area" name="area"
			class="content-foot-box ml-3 text-center copy-font" style="height: 50px; width: 100px;">
	...
	<input type="text" class="titleSearch form-control copy-font"
		id="title" placeholder="  물건을 입력하여주세요"
	...
	<c:if test="${not empty userId}">
		<a href="/post/free_sharing_view"><button type="button"
		...
		<c:forEach var='posts' items='${postList}' varStatus="status">
			<article id="postBox" class="post-box"
				...
				<a href="/post/free_sharing_detail_view?postId=${posts.post.id}"> <img
					...
					<div class="copy-font ml-3 font-weight-bold">
						물건 : <span class="ml-3" id="adoptStatus"
							>${posts.post.status}</span>
					</div>
					<div class="copy-font ml-3 font-weight-bold">
						지역 : <span class="ml-3" id="adoptStatus"
							>${posts.post.area}</span>
					</div>
					<div class="copy-font ml-3 font-weight-bold">
