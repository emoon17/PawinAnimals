...
public class RestAPI {
	 ...
	 private static final String seoulUrl = "http://openapi.seoul.go.kr:8088/";
	...
	public String restTemplate() throws JsonProcessingException{
		...
		try {
			...
			//http://openapi.seoul.go.kr:8088/4a7357466b65756e37386462676f62/json/LOCALDATA_020301/1/5/
			// 4. url와 key값
			UriComponents uri = UriComponentsBuilder.fromHttpUrl(seoulUrl + "4a7357466b65756e37386462676f62" + "/json/LOCALDATA_020301/1/5/").build();
