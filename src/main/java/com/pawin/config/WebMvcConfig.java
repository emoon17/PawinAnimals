...
import com.pawin.interceptor.PermissionInterceptor;
...
//		.addResourceLocations("file:///" + FileManagerService.FILE_UPLOAD_PATH); // 실제 파일 위치 mac: file:// window:file:///
	...
	public void addInterceptors(InterceptorRegistry registry) {	
		...
		.addPathPatterns("/post") // /** : 모든 주소는 다 검사할거다.(아래 디렉토리까지 확인한다)
		.excludePathPatterns("/favicon.ico", "/error", "/static/**", "/user/signOut"); // 이 주소로 들어오면 제외할 거다 /static/**는 yml에 패턴 저장 해놨을 때만 가능하다.
